...
import com.example.android.notepad.application.SYP_Application;
...
public class NotesList extends ListActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        ll_noteList.setBackgroundColor(Color.parseColor(SYP_Application.getBackground()));
        lv_notesList.setBackgroundColor(Color.parseColor(SYP_Application.getBackground()));
